// Version 3: Basic Sobel Edge Detection (NO PRE-BLUR)
// Structurally identical to V4 – simple step-based Sobel is its unique feature.
// Compare with V4 to see the effect of Gaussian pre-blur on noise suppression.
